...
export default function SignUpPage() {
  ...
  const { isOTPSent, isVerified, registrationEmail } = useAppSelector(
    (state) => state.auth
  );
      ...
      <div className={styles.container}>
        <div className={styles.logoSection}>
          ...
          {!isOTPSent ? (
            <>
              ...
              <p className={styles.subtitle}>Một tài khoản cho mọi thứ</p>
            </>
          ) : null}
        </div>
        ...
        <div className={styles.formCard}>
          {!isOTPSent ? (
            ...
            <OTPVerification email={registrationEmail || ''} />
          )}
        </div>
